var s,
    ...
    bigVideo : function() {
        ...
        if(Modernizr.touch){
            ...
            BV.show("video/background-video.mp4",{
                ambient: true,
                doLoop: true,
                altSource: "video/background-video.ogv"
            });
        }
    },
    editNavigation : function() {
        ...
        $('.onepage-pagination').children().each( function() {
            ...
            switch ($(this).children().data('index')) {
                ...
                break;
                case 2 :
                    $(this).children().append("<i class='fa fa-check-square-o'></i>");
                break;
                case 3 :
                    $(this).children().append("<i class='fa fa-users'></i>");
                break;
                case 4 :
                    $(this).children().append("<i class='fa fa-cogs'></i>");
                break;
                case 5 :
                    $(this).children().append("<i class='fa fa-download'></i>");
                break;
            }
        });
    },
